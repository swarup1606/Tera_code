...
def main():
    ...
    if choice == "Home":
        ...
        nitrogen = st.number_input("Enter Nitrogen Content (kg/ha)", min_value=0.0, value=20.0)
        phosphorus = st.number_input("Enter Phosphorus Content (kg/ha)", min_value=0.0, value=15.0)
        potassium = st.number_input("Enter Potassium Content (kg/ha)", min_value=0.0, value=15.0)
        organic_matter = st.number_input("Enter Organic Matter (%)", min_value=0.0, max_value=100.0, value=5.0)
        ...
        city = st.text_input("Enter city name", "London")
        soil_moisture = st.number_input("Enter current soil moisture (%)", min_value=0.0, max_value=100.0, value=30.0)
        ...
        image_path = st.text_input("Enter the path of the crop image", "path/to/your/image.jpg")
